...
public class RandomTimeSeries extends ApplicationFrame {
    ...
    private static final String TITLE = "Car Park Simulation";
	...
	private TimeSeriesCollection createTimeSeriesData() {
		...
		TimeSeries vehTotal = new TimeSeries("Total Vehicles to Date");
		TimeSeries curTotal = new TimeSeries("Currently Parked Vehicles");
		TimeSeries carTotal = new TimeSeries("Total Cars in Car Park");
		TimeSeries scarTotal = new TimeSeries("Total Small Cars in Car Park");
		TimeSeries mcTotal = new TimeSeries("Total MotorCycles in Car Park");
		TimeSeries queueTotal = new TimeSeries("Number of Queued Vehicles");
		TimeSeries archTotal = new TimeSeries("Number Archived");
		TimeSeries dissTotal = new TimeSeries("Number Dissatisfied");
