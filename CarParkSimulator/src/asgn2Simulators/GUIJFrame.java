...
public class GUIJFrame extends JFrame {
	...
	public GUIJFrame() {
		...
		lblMaximumMotorcycleSpaces.setBounds(69, 133, 167, 14);
		...
		DEFAULT_MAX_CAR_SPACES.setBounds(217, 78, 86, 20);
		...
		DEFAULT_MAX_SMALL_CAR_SPACES.setBounds(217, 104, 86, 20);
		...
		DEFAULT_MAX_MOTORCYCLE_SPACES.setBounds(217, 130, 86, 20);
		...
		DEFAULT_MAX_QUEUE_SIZE.setBounds(217, 156, 86, 20);
		...
		DEFAULT_SMALL_CAR_PROB.setBounds(217, 267, 86, 20);
		...
		DEFAULT_MOTORCYCLE_PROB.setBounds(217, 293, 86, 20);
		...
		DEFAULT_INTENDED_STAY_MEAN.setBounds(217, 319, 86, 20);
		...
		DEFAULT_INTENDED_STAY_SD.setBounds(217, 345, 86, 20);
		...
		separator_1.setBounds(10, 373, 505, 2);
